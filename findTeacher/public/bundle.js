...
/***/ function(module, exports, __webpack_require__) {
	...
	//components
	var SearchLine = __webpack_require__(216);
	var TeacherList = __webpack_require__(217);
	...
	var Main = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'wrapper' },
	            React.createElement(SearchLine, null),
	            React.createElement(TeacherList, { teachers: this.state.teachers })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchLine = React.createClass({
	    displayName: "SearchLine",

	    render: function render() {
	        return React.createElement(
	            "div",
	            { className: "search-line-block" },
	            "Line"
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	//components
	var TeacherBlock = __webpack_require__(218);

	var TeacherList = React.createClass({
	    displayName: 'TeacherList',

	    render: function render() {
	        var teachers = this.props.teachers;

	        var renderTeachers = function renderTeachers() {
	            return teachers.map(function (teacher) {
	                return React.createElement(TeacherBlock, _extends({ key: teacher.id }, teacher));
	            });
	        };
	        return React.createElement(
	            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeacherNewsList = __webpack_require__(219);

	var TeacherBlock = React.createClass({
	    displayName: 'TeacherBlock',
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(TeacherNewsList, { news: news })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeacherNews = __webpack_require__(220);

	var TeacherNewsList = React.createClass({
	    displayName: 'TeacherNewsList',

	    render: function render() {
	        var news = this.props.news;

	        var renderTeacherNews = function renderTeacherNews() {
	            return news.map(function (info) {
	                return React.createElement(TeacherNews, { key: info.id, where: info.where, day: info.day, time: info.time, why: info.why });
	            });
	        };

	        return React.createElement(
	            'div',
	            { className: 'teacher-news-list' },
	            React.createElement(
	                'div',
	                { className: 'describe' },
	                React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeacherNews = React.createClass({
	    displayName: "TeacherNews",
